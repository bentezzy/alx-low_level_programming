 ...
 * @e_ident: pointer to an arroy for elf
 */
...
/**
 * print_magic - prints margic num of elf
 * e_ident: pointer to an arroy for elf
 */
...
/**
 * print_osabi - prints OS or ABI of elf
 * @e_ident: pointer to array of elf
 */
...
/**
 * main - prints info on the elf header
 * @argc: number of argumrnts on elf prog
